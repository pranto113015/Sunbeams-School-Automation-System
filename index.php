    ...
    <div class="black-fill"><br /> <br />
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        <li class="nav-item">
		          <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-house fa-2xs"></i> Home</a>
		        </li>
		        <li class="nav-item">
		      ...
		      <ul class="navbar-nav me-right mb-2 mb-lg-0">
		      	<li class="nav-item">
		          <a class="nav-link" href="login.php"><i class="fa-solid fa-user fa-xs"></i> Login</a>
		        </li>
		      </ul>
		  </div>
		    </div>
			  ...
			  <div class="row g-0">
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
			        ...
			        <p class="card-text"><small class="text-muted">Sunbeams School</small></p>
			      </div>
			    </div>
			  </div>
			</div>
        ...
        <section id="contact"
        	...
        	<form method="post"
			  ...
			  <button type="submit" class="btn btn-primary"><i class="fa-solid fa-paper-plane fa-2xs"></i> Send</button>
			</form>
        </section>
